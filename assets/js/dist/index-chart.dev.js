...
(function ($) {
  ...
  $('.ms-medical-overview-slider').slick((_$$slick = {
    dots: false,
    arrows: false,
    infinite: false,
    slidesToShow: 4
  }, _defineProperty(_$$slick, "arrows", true), _defineProperty(_$$slick, "prevArrow", $('.prev-item')), _defineProperty(_$$slick, "nextArrow", $('.next-item')), _defineProperty(_$$slick, "responsive", [{
    breakpoint: 1400,
    settings: {
      slidesToShow: 2,
      slidesToScroll: 1,
  ...
  gradientFill.addColorStop(1, "rgba(255,255,255)"); // all data
